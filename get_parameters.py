...
def get_user_parameters():
    ...
    parser.add_argument("ftp_website", help="Full FTP Website(username,password,directory) ", type=str)  #ftp://192.168.31.163/
    parser.add_argument("local_directory", help="Directory we want to synchronize", type=str) #C:/Users/18917/Desktop/ftp
    ...
    parser.add_argument("max_thread_num", help="Maximal number of thread", type=int)
    ...
    if wrong_input is False:
        ...
        return ftp_website, local_directory, max_depth, refresh_frequency, max_thread_num, excluded_extensions
    else:
        return 0
